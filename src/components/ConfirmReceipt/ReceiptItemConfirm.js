import classes from "./ReceiptItemConfirm.module.css";

const ReceiptItemConfirm = (props) => {
  return (
    <div className={classes.receipt_wrapper}>
      <div className={classes.receipt_item}>
        ...
        <div className={classes.receipt_item_action}>
          <button onClick={props.updateModalHandler}>
            <svg
...
export default ReceiptItemConfirm;
